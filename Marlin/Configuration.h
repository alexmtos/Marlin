...
#define STRING_CONFIG_H_AUTHOR "(BIQU - AlexConfig, BIQU-B1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BIQU-B1_SKR-V1_4"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 400, 404.4 }
